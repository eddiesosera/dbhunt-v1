  ...
  return (
    <View style={styles.container}>
      ...
      {isUserLoggedIn ? (
        ...
        <NotLoggedIn label={'Join to view Hunt Fixture'} />
      )}
          ...
          <View style={styles.listHeaderWrap}>
            <View style={styles.listHeaderLeftWrap}>
              ...
              <View style={styles.numberOfHuntsWrap}>
                <Text style={styles.numberOfHuntsText}>
                  {" "}
                  {HuntsDummyData?.length}{" "}
                </Text>
              </View>
            </View>
      ...
      {isUserLoggedIn && (
        <TouchableOpacity
          style={[GlobalStyle.PrimaryIconButton, styles.addButton]}
          onPress={goToCreate}
        >
