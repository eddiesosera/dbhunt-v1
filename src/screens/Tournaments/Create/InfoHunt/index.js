import { FlatList, Image, SafeAreaView, ScrollView, StyleSheet, Switch, Text, TextInput, TouchableOpacity, View } from 'react-native'
...
export const InfoHuntScreen = () => {
    ...
    const handleCreation = async () => {
        var items = { title, startsOn: formatDate(startsOn), endsOn: formatDate(endsOn), description, reward }
    ...
    useEffect(() => {
    }, [startsOn, endsOn, isTitleActive, isDescriptionActive]);

    return (
        <View style={styles.container}>

            <Image source={bgImg} style={{ position: 'absolute', width: '100%', height: '100%' }} />
            ...
            <ScrollView style={{ margin: 20, marginBottom: 0 }}>
                ...
                <View
                    ...
                    <TextInput
                        ...
                        onFocus={() => { setTitlePlaceholder(''), setIsTitleActive(true) }}
                        onBlur={() => { setTitlePlaceholder('Title'), setIsTitleActive(false) }}
                    />
                </View>
                ...
                <View
                    ...
                    <Dropdown
                        ...
                        itemContainerStyle={{ borderTopWidth: 0.5, borderTopColor: '#ccc', marginHorizontal: 10 }}
                        ...
                        renderLeftIcon={() => (
                            <Octicons name="location" size={16} color="#B3B0AA" style={styles.icon} />
                        )}
                    />
                </View>
                ...
                <View style={styles.dateWidget}>
                    ...
                    <View
                        ...
                        <DateTimePicker
                            ...
                            selectedTextStyle={{ fontFamily: 'Mona-Sans Wide', color: '#111' }}
                        ...
                        />
                        <TouchableOpacity onPress={() => setIsDateOpen(!isDateOpen)}
                            style={
                                [GlobalStyle.LightOutlineButton,
                                { marginTop: 10, flexWrap: 'wrap', width: 120, paddingVertical: 15 }]}>
                            <Text
                                style={[GlobalStyle.LightOutlineButtonText,
                                { fontSize: 14 }]}>
                                Save Date
                            </Text>
                        </TouchableOpacity>
                ...
                <View
                    ...
                    <Dropdown
                        ...
                        renderLeftIcon={() => (
                            <MaterialCommunityIcons name="trophy-award" size={16} color="#B3B0AA" style={styles.icon} />
                            // <Octicons name="location" size={16} color="#B3B0AA" style={styles.icon} />
                        )}
                    />
                </View>
